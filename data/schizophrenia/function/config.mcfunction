...
execute if score #RandomNametag TwistConfig matches 1 run tellraw @a ["",{text:"- Random Nametag Twist: ",color:"gray"},{text:"[ENABLED]",color:"green",bold:true,click_event:{action:"run_command",command:"/function schizophrenia:twists/mob_flicker_swap/toggle"},hover_event:{action:"show_text",value:[{text:"Click to Disable",color:"red"}]}}]
execute if score #RandomNametag TwistConfig matches 1 run tellraw @a ["",{text:"- Random Nametag Twist: ",color:"gray"},{text:"[ENABLED]",color:"green",bold:true,click_event:{action:"run_command",command:"/function schizophrenia:twists/mob_flicker_swap/toggle"},hover_event:{action:"show_text",value:[{text:"Click to Disable",color:"red"}]}}]
