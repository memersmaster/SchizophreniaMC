...
execute if score #RandomNametag TwistConfig matches 0 run tellraw @a ["",{text:"- Random Nametag Twist: ",color:"gray"},{text:"[DISABLED]",color:"red",bold:true,click_event:{action:"run_command",command:"/function schizophrenia:twists/random_nametag/toggle"},hover_event:{action:"show_text",value:[{text:"Click to Enable",color:"green"}]}}]
execute if score #RandomNametag TwistConfig matches 1 run tellraw @a ["",{text:"- Random Nametag Twist: ",color:"gray"},{text:"[ENABLED]",color:"green",bold:true,click_event:{action:"run_command",command:"/function schizophrenia:twists/random_nametag/toggle"},hover_event:{action:"show_text",value:[{text:"Click to Disable",color:"red"}]}}]
