...
execute unless score #EntityStare TwistConfig matches 0 run scoreboard players set #EntityStare TwistConfig 1
...
scoreboard players set #EntityStare Chance 1
