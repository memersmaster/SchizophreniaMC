...
execute if score @s afkDis.x2 = @s afkDis.x1 if score @s afkDis.y2 = @s afkDis.y1 if score @s afkDis.z2 = @s afkDis.z1 run function schizophrenia:twists/door_knocking/door_knocking
...
scoreboard players set @s afkDis.checkAFK 5