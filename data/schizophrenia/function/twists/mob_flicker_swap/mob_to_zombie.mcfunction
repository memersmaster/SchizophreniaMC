...
summon minecraft:husk ^ ^100 ^ {HasVisualFire:0b,NoGravity:1b,Silent:1b,Invulnerable:1b,Glowing:0b,CustomNameVisible:0b,LeftHanded:0b,PersistenceRequired:1b,NoAI:1b,CanPickUpLoot:0b,Tags:["temp_flicker_zombie"]}
